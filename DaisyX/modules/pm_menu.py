...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://visi.tk/lizza"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/Lizza_Updates"),
        InlineKeyboardButton(
            strings["btn_group"], url="https://t.me/Lizzasupport"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            "ADD LIZZA TO YOUR GROUP",
            url=f"https://telegram.me/MissLizza_bot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/MissLizza_bot?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
